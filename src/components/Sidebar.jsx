...
const Sidebar = ({ Vector, }) => {
    ...
    return (
        <>
            <aside className="fixed bottom-0 left-0 right-0 z-50 border-t border-white/10 bg-[#0C0E0B]/95 backdrop-blur-md px-2 py-2 md:left-0 md:top-0 md:right-auto md:h-screen md:w-[70px] md:border-r md:border-t-0 md:px-0 md:py-6">
                <div className="hidden md:block mb-4"> <img src={Vector} alt="Logo" className="w-6 h-6 mx-auto" /> </div>
                <div className="hidden md:block w-8 h-[1px] bg-white/10 mb-[26px] mx-auto" />
                <div className="flex flex-row justify-around items-center md:flex-col md:gap-y-[10px]">
                    <button aria-label="Home" onClick={() => navigate("/home")} className={`w-11 h-11 md:w-12 md:h-12 flex items-center justify-center rounded-[10px] transition-all duration-200 active:scale-95 ${isHome || isCareerDetail || isLearningPath ? "bg-[#1A2218] shadow-inner" : "hover:bg-white/5 opacity-90 md:opacity-60 hover:opacity-100"}`} >
                    ...
                    <button aria-label="Jobs" onClick={() => navigate("/jobs")} className={`w-11 h-11 md:w-12 md:h-12 flex items-center justify-center rounded-[10px] transition-all duration-200 active:scale-95 ${isJobs || isJobDetail ? "bg-[#1A2218]" : "hover:bg-white/5 opacity-90 md:opacity-60 hover:opacity-100"}`} >
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M16 20V4C16 3.46957 15.7893 2.96086 15.4142 2.58579C15.0391 2.21071 14.5304 2 14 2H10C9.46957 2 8.96086 2.21071 8.58579 2.58579C8.21071 2.96086 8 3.46957 8 4V20M4 6H20C21.1046 6 22 6.89543 22 8V18C22 19.1046 21.1046 20 20 20H4C2.89543 20 2 19.1046 2 18V8C2 6.89543 2.89543 6 4 6Z" stroke={isJobs || isJobDetail ? "url(#jobIconGradient)" : "white"} strokeOpacity={isJobs || isJobDetail ? "1" : "0.6"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                    </button>
                    <button aria-label="Career listing" onClick={() => navigate("/careerlisting")} className={`w-11 h-11 md:w-12 md:h-12 flex items-center justify-center rounded-[10px] transition-all duration-200 active:scale-95 ${isCareerListing ? "bg-[#1A2218] shadow-inner" : "hover:bg-white/5 opacity-90 md:opacity-60 hover:opacity-100"}`} >
