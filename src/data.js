...
export const roles = [
    { id: "devops-engineer", title: "DevOps Engineer", salary: "$150k", vibe: "80%", description: "Automates development pipelines, system configurations, and manages scalable cloud infrastructures.", skills: ["Docker", "AWS", "CI/CD", "Kubernetes"], cardBg: "#E2DBF0", boxBg: "#D2CADF", cardBg1: "#C3BBD0" },
    { id: "product-manager", title: "Product Manager", salary: "$140k", vibe: "88%", description: "Owns the overall product lifecycle from discovery, business modeling, to release execution.", skills: ["Strategy", "KPIs", "Stakeholder Mgmt", "SCRUM"], cardBg: "#F3D7EC", boxBg: "#E5C8DE", cardBg1: "#D8BCD1" },
    ...
    { id: "ai-engineer", title: "AI Engineer", salary: "$165k", vibe: "70%", description: "Creates machine learning pipelines, predictive engines, and neural models for intelligent decision making.", skills: ["PyTorch", "TensorFlow", "NLP", "Data Pipelines"], cardBg: "#E2DBF0", boxBg: "#D2CADF", cardBg1: "#C3BBD0" },
    { id: "mobile-app-developer", title: "Mobile App Developer", salary: "$130k", vibe: "82%", description: "Builds high-performance native and cross-platform mobile applications for iOS and Android.", skills: ["Flutter", "Swift", "Kotlin", "State Management"], cardBg: "#D4EBF8", boxBg: "#C4DCED", cardBg1: "#B5CDDE" },
    { id: "full-stack-engineer", title: "Full Stack Engineer", salary: "$145k", vibe: "75%", description: "Designs, maintains, and implements front-end interfaces along with secure database architectures.", skills: ["React.js", "Node.js", "PostgreSQL", "API Design"], cardBg: "#D4EBF8", boxBg: "#C4DCED", cardBg1: "#B5CDDE" },
    ...
    { id: "ux-researcher", title: "UX Researcher", salary: "$110k", vibe: "95%", description: "Conducts studies and user interviews to inform design and development cycles with real customer feedback.", skills: ["Interviews", "Usability Testing", "Personas", "Analytics"], cardBg: "#F9EFC7", boxBg: "#E9DFB8", cardBg1: "#DAD0AA" },
    { id: "digital-strategist", title: "Digital Strategist", salary: "$100k", vibe: "92%", description: "Designs conversion funnels, paid acquisition structures, and SEO blueprints to improve search footprints.", skills: ["Google Analytics", "SEO", "Copywriting", "A/B Testing"], cardBg: "#F9EFC7", boxBg: "#E9DFB8", cardBg1: "#DAD0AA" },
    ...
    { id: "cybersecurity-eng", title: "Cybersecurity Eng", salary: "$135k", vibe: "78%", description: "Protects networks, computer systems, and user data from security breaches and malicious system access.", skills: ["Pen Testing", "Network Security", "Linux", "Ethical Hacking"], cardBg: "#F7EAD3", boxBg: "#EADCC5", cardBg1: "#DFD2BB" },
    { id: "qa-automation-tester", title: "QA Automation Tester", salary: "$105k", vibe: "87%", description: "Develops Automated testing scripts to run end-to-end user checks on platforms prior to product deployment.", skills: ["Selenium", "Cypress", "JavaScript", "Writing Test Cases"], cardBg: "#D6F0DB", boxBg: "#C7E1CC", cardBg1: "#B9D3BE" },
];
